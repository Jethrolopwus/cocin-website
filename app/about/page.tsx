                ...
                <div className="bg-[#1F2937] rounded-2xl p-7 text-white sticky top-28">
                  ...
                  <div className="flex flex-col gap-3 mb-6">
                    ...
                    <button
                      ...
                      className="w-full inline-flex items-center justify-center gap-2 bg-[#374151] hover:bg-[#4B5563] text-white font-semibold py-3 rounded-full transition-colors text-sm border border-gray-600"
                    >
                      <Heart size={16} />
